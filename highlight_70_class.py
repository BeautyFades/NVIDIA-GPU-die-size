...
# Plot points for the "70 class" with 100% opacity
scatter_70_class = sns.scatterplot(
    data=df[df['name'].str.contains('70')],
...
for i in range(len(df)):
    ...
    alpha_value = 0.18 if '70' not in df['name'][i] else 1.0
