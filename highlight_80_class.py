...
# Plot points for the "80 class" with 100% opacity
scatter_80_class = sns.scatterplot(
    data=df[df['name'].str.contains('80')],
...
for i in range(len(df)):
    ...
    alpha_value = 0.18 if '80' not in df['name'][i] else 1.0
